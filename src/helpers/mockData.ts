...
const localData = {
  goals: [
    {
      id: '111',
      createdAt: new Date('March 05 2020'),
      updatedAt: new Date('June 05 2020'),
    },
    {
      id: '112',
      createdAt: new Date('March 05 2020'),
      updatedAt: new Date('June 04 2020'),
    },
    {
      id: '113',
      createdAt: new Date('March 05 2020'),
      updatedAt: new Date('June 03 2020'),
    },
  ],
  users: [{id: '18'}, {id: '22'}, {id: '27'}],
  updates: [
...
function prepData(data: {updates: any; goals: any; users: any}): Input {
  ...
  return {
    ...
    goals: goals.map(({createdAt, updatedAt, ...rest}: any) => ({
      ...rest,
      createdAt: castAsDate(createdAt),
